# -*- coding: utf-8 -*-
"""
Created on Sun Oct 16 21:30:59 2022
...
class Greedy:
    ...
    def add(self, node):
        # print("Heuristic node : " + str(node.heuristic))
        # try:
...
class colournode:
    def __init__(self, filename):
        ...
        # Read file and set height and width of network map
...
if len(sys.argv) != 2:
    sys.exit("Usage: python 134782.py ")
